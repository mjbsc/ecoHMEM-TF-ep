...
class SplitDataset():
    ...
    def __split_dataset(self):
        ...
        for index in range(len(all_file_paths)):
            ...
            self.valid_file_path.append([self.index_label_dict[index], file_path_list[train_num:train_num + test_num:]])
            #print("Index = ", index)
            #print("1st valid sample = ", self.valid_file_path[0])
            #print("final valid sample = ", self.valid_file_path[-1])
            #self.valid_file_path.append([self.index_label_dict[index], file_path_list[train_num:train_num+test_num]])
